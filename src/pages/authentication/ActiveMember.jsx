    ...
    return (
        <React.Fragment>
            ...
            <div className="container mt--80 mb--80">
                ...
                <br />
                <p>Като активен член на Bulgarian Society Rotterdam, ще работиш в разрастващ и развиващ се екип от борд и комитети. Също така ще имаш намaления за събитията на BGSG, както и достъп до събития, организирани за целия екип, с цел обмяна на информация и сплотяване на екипа. </p>
                <br />
