    ...
    return (
        <React.Fragment>
            ...
            <div className="container mt--80 mb--80">
                <p>Екипът на Българското Общество в Холандия се разраства вече и в Ротердам! През 2022 година бе основано Българкото Общество в Грьонинген. След една много успешна година стана време за  търсим попълнения в нашия отбор. Ако си ентусиазиран и постоянен, обичаш да организираш събития и споделяш мисията на Обществото, кандидатствай за свободните ни позиции като отговориш на въпросите (до 200 думи на въпрос) и, ако имаш желание, ни изпратиш CV (до 300 думи).</p>
                <br />
                <p>Като активен член на Bulgarian Society Rotterdam, ще работиш в разрастващ и развиващ се екип от борд и комитети. Също така ще имаш намaления за събитията на , както и достъп до събития, организирани за целия екип, с цел обмяна на информация и сплотяване на екипа. </p>
                <br />
