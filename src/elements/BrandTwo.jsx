...
class BrandTwo extends Component {
    render() {
        return (
            <div className="rn-brand-area brand-separation bg_color--5 pt--40 mb-20">
                <h3 style={{ textAlign: 'center', fontFamily: 'Archive' }}>Partners</h3>
                <ul className="brand-style-2">
                    <li>
                        <a href='https://www.bulgariansocietygro.nl/' target='_blank'><img src="/assets/images/brand/brand-08.jpg" style={{borderRadius:"50%"}} alt="Logo Images" /></a>
                    </li>
                    <li>
                        <a href='https://www.bulgariansocietylwd.nl/' target='_blank'><img src="/assets/images/brand/brand-09.jpg" style={{borderRadius:"50%"}} alt="Logo Images" /></a>
                    </li>
                    <li>
